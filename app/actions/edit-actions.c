...
static const GimpActionEntry edit_actions[] =
{
  ...
  { "edit-fontinc", GIMP_ICON_FORMAT_TEXT_FONTINC,
  ...
  { "edit-fontdec", GIMP_ICON_FORMAT_TEXT_FONTDEC,
